...
# GagituAldi Deployment Script
# Run this script on your VPS

set -e

echo "🚀 Starting deployment for GagituAldi Landing Page..."
...
echo -e "${BLUE}Step 4: Installing PM2 globally...${NC}"
npm install -g pm2
...
echo -e "${BLUE}Step 9: Setting up PM2...${NC}"
...
echo -e "${BLUE}Step 11: Testing and restarting Nginx...${NC}"
nginx -t
...
echo "  - http://gagitualdi.online (after DNS propagation)"
echo ""
echo -e "${BLUE}To setup SSL (HTTPS), run:${NC}"
echo "  apt install -y certbot python3-certbot-nginx"
echo "  certbot --nginx -d gagitualdi.online -d www.gagitualdi.online"
echo ""
echo -e "${BLUE}Useful commands:${NC}"
echo "  pm2 status          - Check PM2 status"
echo "  pm2 logs gagitualdi - View logs"
echo "  pm2 restart gagitualdi - Restart app"
